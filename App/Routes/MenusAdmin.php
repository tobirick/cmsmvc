...
$router->map('GET', '/admin/menus', requireLogin('Admin\MenusController@index'));
$router->map('GET', '/admin/menus/create', requireLogin('Admin\MenusController@create'));
$router->map('GET', '/admin/menus/[i:id]/edit', requireLogin('Admin\MenusController@edit'));
