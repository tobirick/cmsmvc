...
$router->map('POST', '/admin/translations/edit', requireLogin('Admin\TranslationsController@updateTranslations'));
$router->map('POST', '/admin/translations/create', requireLogin('Admin\TranslationsController@createTranslation'));
$router->map('POST', '/admin/translations/[i:id]/delete', requireLogin('Admin\TranslationsController@deleteTranslations'));